...
wang_sun_attractor = AttractorConfig(
    ...
    prompts=[
        "Adjusting $a$ and $d$ will determine if the system converges to a point or \
            explodes into chaos.",
        "$c$ influences the strength of the coupling between the wings. Higher values \
                tend to stretch the attractor along the x-axis.",
        ...
        "$e$ and $f$ control the vertical stability. Modifying $e$ will \
            often squash or elongate the attractor along the z-axis.",
    ],
)
